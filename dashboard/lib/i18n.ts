...
export const translations = {
  he: {
    ...
    af_voice_zephyr: "זפיר — נשי, חמים ונעים",
    af_voice_puck: "פאק — גברי, אנרגטי",
    af_voice_charon: "כארון — גברי, עמוק",
    af_voice_kore: "קורי — נשי, רגוע",
    af_voice_fenrir: "פנריר — גברי, מקצועי",
    af_voice_aoede: "אאידה — נשי, מלודי",
    ...
    af_test_call_label: "מספר טלפון לשיחת בדיקה",
    af_test_call_placeholder: "+972...",
    af_test_call_btn: "בדיקת שיחה",
    af_test_call_loading: "מתחבר...",
    af_test_call_success: "השיחה בדרך! בדוק את הטלפון שלך",
    af_test_call_error: "שגיאה בהפעלת שיחת הבדיקה",
    ...
    af_appt_followup_label: "תזכורת לפני פגישה",
    af_appt_followup_hint: "מאיה תשלח הודעת תזכורת לפני המועד שנקבע",
    af_appt_followup_timing_label: "מתי לשלוח את התזכורת?",
    af_appt_followup_timing_1day: "יום לפני",
    af_appt_followup_timing_2hours: "שעתיים לפני",
    af_appt_followup_timing_1hour: "שעה לפני",
  ...
  en: {
    ...
    af_voice_zephyr: "Zephyr — female, warm, pleasant",
    af_voice_puck: "Puck — male, energetic",
    af_voice_charon: "Charon — male, deep",
    af_voice_kore: "Kore — female, calm",
    af_voice_fenrir: "Fenrir — male, professional",
    af_voice_aoede: "Aoede — female, melodic",
    ...
    af_test_call_label: "Test call phone number",
    af_test_call_placeholder: "+1...",
    af_test_call_btn: "Test Call",
    af_test_call_loading: "Connecting...",
    af_test_call_success: "Call on its way! Check your phone",
    af_test_call_error: "Failed to initiate test call",
    ...
    af_appt_followup_label: "Appointment Reminder",
    af_appt_followup_hint: "Maya sends a reminder message before the scheduled appointment",
    af_appt_followup_timing_label: "When to send the reminder?",
    af_appt_followup_timing_1day: "1 day before",
    af_appt_followup_timing_2hours: "2 hours before",
    af_appt_followup_timing_1hour: "1 hour before",
