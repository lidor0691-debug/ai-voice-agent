...
"[project]/app/api/clients/[client_id]/assets/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("client_assets").update(body).eq("id", id).eq("client_id", client_id).select().single();
...
async function DELETE(_, { params }) {
    const { client_id, id } = await params;
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("client_assets").delete().eq("id", id).eq("client_id", client_id);
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 400
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e4a1636._.js.map